  ...
  return (
    <div className={classes} aria-label={`Note ${normalizedRating} sur ${max}`}>
      {[...Array(max)].map((_, index) => (
        // On crée un tableau de la taille max et on mappe dessus pour afficher les étoiles
        // Si l'index est inférieur à la note normalisée, on ajoute la classe pour étoile remplie
